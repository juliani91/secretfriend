...
var mailOptions={
to : req.query.to,
subject : req.query.arraySubject[0].toString(),
//text : req.query.text
}
...
var mailOptions2={
to : req.query.to2,
subject : req.query.arraySubject[1].toString(),
//text : req.query.text
}
...
var mailOptions3={
to : req.query.to3,
subject : req.query.arraySubject[2].toString(),
//text : req.query.text
}
...
var mailOptions4={
to : req.query.to4,
subject : req.query.arraySubject[3].toString(),
//text : req.query.text
}
